...
{"FilePath": os.path.join("static", "electricity.pdf"), "ImagePath": os.path.join("static", "electricity.pdf"), "Filename": "Electricity", "name":"Ethan", "tags":[], "ratings":[], "rating":3, "grade": 5},
...
{"FilePath": os.path.join("static", "1812.pdf"), "ImagePath": os.path.join("static", "1812.pdf"), "Filename": "War of 1812", "name":"Fred", "tags":[], "ratings":[], "rating":3, "grade":6},
{"FilePath": os.path.join("static", "genderstudies.pdf"), "ImagePath": os.path.join("static", "genderstudies.pdf"), "Filename": "Gender Studies", "name":"Bob", "tags":[], "ratings":[], "rating":3, "grade": 3},
]
...
def browse():
    if request.method == "POST":
        ...
        for i in range(0, len(notes)-1):
            if abs(int(notes[i]["grade"]) - int(request.form["gradeRange"])) > 1:
                poplist.append(i)
